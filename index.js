...
function SendMessage() {
  ...
  commentName.textContent = Namebox.value;
  commentMessage.textContent = Messagebox.value;

  commentSection.appendChild(clone);

  // Clear inputs and disable send button again
  Namebox.value = "";
  Messagebox.value = "";
  sendButton.disabled = true;

  counter.textContent = "Reviews: " + messageCount;
}
